...
import { submitIdea } from "@/app/(app)/roadmap/actions";
          ...
          {submitted ? (
            ...
            <>
              ...
              <Dialog.Description className="mt-2 text-sm text-muted-foreground">
                What should we build next? Share your idea and the community can
                vote on it.
              </Dialog.Description>

              <div className="mt-4 space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="idea-title" className="text-sm">
                    Title
                  </Label>
                  <Input
                    id="idea-title"
                ...
                <div className="space-y-2">
                  <Label htmlFor="idea-description" className="text-sm">
                    Description{" "}
                ...
                <div className="space-y-2">
                  <Label htmlFor="idea-category" className="text-sm">
                    Category{" "}
                    <span className="text-muted-foreground">(optional)</span>
                  </Label>
                  <select
                    ...
                    className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30"
                  >
